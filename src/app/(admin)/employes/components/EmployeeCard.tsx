...
const EmployeeCard: React.FC = () => {
  ...
  const { data, loading, error, refetch } = useFetchData<CustomerResponse>(
      API_ENDPOINTS.USERS,
      ...
      <Card>
        <CardHeader className="border-bottom card-tabs d-flex flex-wrap align-items-center gap-2">
          <div className="flex-grow-1">
            <h4 className="header-title">Employes</h4>
          </div>
          ...
          <div className="d-flex flex-wrap flex-lg-nowrap gap-2">
            ...
            <Link href="/employes/add" className="btn btn-primary">
        ...
        <div className="table-responsive">
          {loading ? (
              ...
              <p className="text-center p-3 text-muted">Aucun employe trouvé</p>
          ) : (
                    ...
                    <tr key={c.id}>
                      ...
                      <td className="text-center pe-3">
                        <Dropdown>
                          ...
                          <DropdownMenu>
                            <DropdownItem as={Link} href={`/customers/${c.id}`}>
                              Détails
                            </DropdownItem>
                            <DropdownItem as={Link} href={`/customers/senders/${c.id}`}>
                              expediteurs
                            </DropdownItem>
                            <DropdownItem as={Link} href={`/customers/beneficiaries/${c.id}`}>
                              Beneficiares
                            </DropdownItem>
                          </DropdownMenu>
                        </Dropdown>
