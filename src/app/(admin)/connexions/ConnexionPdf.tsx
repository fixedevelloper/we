...
export default function ConnexionPdfModal({
                                                audits,
                                                show,
                                                onClose,
                                                begin_date,
    ...
    return (
        <Modal show={show} onHide={onClose} size="lg" centered>
            <Modal.Header closeButton>
                <Modal.Title>Rapport des connexions</Modal.Title>
            </Modal.Header>
                ...
                <div ref={receiptRef} className="pdf-container">
                    ...
                    <div className="pdf-header">
                        <div className="pdf-brand">
                            ...
                            <p className="text-muted">Listes des Connexions</p>
                        </div>
                  ...
                  <th className="fs-12 text-uppercase ">User</th>
                                  <th className="fs-12 text-uppercase">Ip Address</th>
                  <th className="fs-12 text-uppercase">Status</th>
