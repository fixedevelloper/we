          ...
          <Card>
            <CardBody>
              <div className="d-flex align-items-start gap-2 justify-content-between">
                <div>
                  <h5 className="text-muted fs-13 fw-bold text-uppercase" title="Transferts">
                    Total Transfert
                  </h5>
                  <h3 className="mt-2 mb-1 fw-bold">1.250.000 F</h3>
        ...
        <Col>
          <Card>
            <CardBody>
              <div className="d-flex align-items-start gap-2 justify-content-between">
                <div>
                  <h5 className="text-muted fs-13 fw-bold text-uppercase" title="Total recharge">
                    Total recharge
                  </h5>
                  <h3 className="mt-2 mb-1 fw-bold">48.700.000</h3>
                  <p className="mb-0 text-muted">
                    <span className="text-success me-1">
                      <IconifyIcon icon="ri:arrow-up-line" style={{ marginBottom: '5px', marginRight: '5px' }} />
                      10.12%
